...
const ToppersSection: React.FC = () => {
  return (
    ...
    <section className=" text-white lg:px-4 px-4 py-10">
        <div className="flex flex-col lg:flex-row gap-4 justify-between">
          <div className='px-4 lg:px-0'>
            <div className="bg-[#1E1E1E] w-full md:w-[358px] rounded-2xl p-6 flex-[1] md:mx-auto lg:mx-0">
              ...
              <div className="mt-6 text-center">
                <button className="border w-[90%] border-[#0077FF] text-white rounded-full px-6 py-2 text-sm font-semibold hover:bg-[#0077FF] transition">
                  See NEET Results
                </button>
              </div>
            ...
            {/* Right - Stats (Larger) */}
            <div className="bg-[#1E1E1E] rounded-2xl p-6 flex-[2]">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {stats.map((stat, index) => (
                  <div
                    key={index}
                    className={`rounded-xl px-4 py-4 bg-black bg-opacity-30 ${stat.border}`}
                  >
